...
namespace NetDream.Modules.Shop.Migrations
{
    public class ActivityEntityTypeConfiguration : IEntityTypeConfiguration<ActivityEntity>
    {
        public void Configure(EntityTypeBuilder<ActivityEntity> builder)
        {
            ...
            builder.Property(table => table.Type).HasColumnName("type").HasMaxLength(2).HasDefaultValue(ActivityModel.TYPE_AUCTION);
            ...
            builder.Property(table => table.Status).HasColumnName("status").HasDefaultValue(ActivityModel.STATUS_NONE).HasComment("开启关闭");
