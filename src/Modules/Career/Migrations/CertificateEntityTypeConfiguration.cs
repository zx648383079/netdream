...
public class CertificateEntityTypeConfiguration : IEntityTypeConfiguration<CertificateEntity>
{
    public void Configure(EntityTypeBuilder<CertificateEntity> builder)
    {
        builder.ToTable("career_certificate", table => table.HasComment("个人获得的证书"));
        ...
        builder.Property(table => table.IsGot).HasColumnName("is_got").HasDefaultValue(0).HasComment("是否获得");
