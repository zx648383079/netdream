...
namespace NetDream.Modules.Trade.Migrations
{
    internal class TradeEntityTypeConfiguration : IEntityTypeConfiguration<TradeEntity>
    {
        public void Configure(EntityTypeBuilder<TradeEntity> builder)
        {
            ...
            builder.Property(table => table.BuyerId).HasColumnName("buyer_id").HasMaxLength(32).HasColumnName("buyer_id").HasComment("买家");
            builder.Property(table => table.SellerId).HasColumnName("seller_id").HasMaxLength(32).HasColumnName("seller_id").HasComment("收款方");
            ...
            builder.Property(table => table.TimeExpire).HasColumnName("time_expire").HasComment("该笔订单允许的最晚付款时间，逾期将关闭交易");
