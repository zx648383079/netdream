...
{
    public class ClanMetaEntityTypeConfiguration : IEntityTypeConfiguration<ClanMetaEntity>
    {
        public void Configure(EntityTypeBuilder<ClanMetaEntity> builder)
        {
            builder.ToTable("clan_meta", table => table.HasComment("家族附录"));
