...
namespace NetDream.Api.Controllers.Finance
{
    ...
    [Authorize()]
    [ApiController]
    public class AccountController(AccountRepository repository) : JsonController
    {

        [HttpGet]
        [Route("")]
        [ProducesResponseType(typeof(DataResponse<MoneyAccountEntity>), 200)]
        ...
        [HttpGet]
        [Route("[action]")]
        [ProducesResponseType(typeof(MoneyAccountEntity), 200)]
        [ProducesResponseType(typeof(FailureResponse), 404)]
        ...
        [ProducesResponseType(typeof(MoneyAccountEntity), 200)]
        [ProducesResponseType(typeof(FailureResponse), 404)]
        public IActionResult Save([FromBody] AccountForm form)
        {
