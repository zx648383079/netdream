...
{
    [Route("open/contact/admin/feedback")]
    [Authorize(Roles = IdentityRepository.Administrator)]
    [ApiController]
    public class FeedbackBackendController(FeedbackRepository repository) : JsonController
    {
        [HttpGet]
        [Route("")]
        ...
        [ProducesResponseType(typeof(FeedbackEntity), 200)]
        [ProducesResponseType(typeof(FailureResponse), 404)]
        public IActionResult Change(int id, string[] data)
        {
